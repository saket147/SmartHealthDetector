...
public class DiseaseActivity extends Activity implements NetworkResponseListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fetchData.setUrl("https://healthservice.priaid.ch/issues?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..smK50dZJD8UzrrnsY_MhaJVf8q-4T85_zjbKNNQSIfw&language=en-gb&format=json");
        fetchData.execute();
    }
    @Override
        ...
        try {
            ...
            for (int i=0;i<issuesArrayList.size();i++){
                    for(int j=0;j<disease.getHsl().length();j++){
                        if(((issuesArrayList.get(i).getId())*1.0)==(double)(disease.getHsl().get(j))){
